export const WEIGHT_CATEGORIES = [
  { id: 'light', icon: '📦', label: 'Light (0–1 kg)', price: 49, desc: 'Envelopes, keys, small documents' },
  { id: 'medium', icon: '📦', label: 'Medium (1–5 kg)', price: 99, desc: 'Books, clothes, medium box' },
  { id: 'heavy', icon: '📦', label: 'Heavy (5–10 kg)', price: 179, desc: 'Large packages, groceries, hardware' }
];
