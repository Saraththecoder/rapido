        ...
        <div className="bg-[#F8F8F8] border border-[#E5E5E5] rounded-2xl p-4 text-left">
          ...
          <div className="w-full h-32 flex items-end justify-between px-1">
            ...
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-gray-600">₹5K</span>
              <div className="w-5 bg-orange-500/20 hover:bg-orange-500 rounded-t-sm transition-all" style={{ height: '35px' }}></div>
              <span className="text-[9px] font-bold text-gray-400">M</span>
            </div>
            {/* Tuesday bar */}
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-gray-600">₹6.5K</span>
              <div className="w-5 bg-orange-500/30 hover:bg-orange-500 rounded-t-sm transition-all" style={{ height: '46px' }}></div>
              <span className="text-[9px] font-bold text-gray-400">T</span>
            </div>
            {/* Wednesday bar */}
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-gray-600">₹8K</span>
              <div className="w-5 bg-orange-500/40 hover:bg-orange-500 rounded-t-sm transition-all" style={{ height: '56px' }}></div>
              <span className="text-[9px] font-bold text-gray-400">W</span>
            </div>
            {/* Thursday bar */}
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-gray-600">₹10K</span>
              <div className="w-5 bg-orange-500/60 hover:bg-orange-500 rounded-t-sm transition-all" style={{ height: '70px' }}></div>
              <span className="text-[9px] font-bold text-gray-400">T</span>
            </div>
            {/* Friday bar */}
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-gray-600">₹12K</span>
              <div className="w-5 bg-orange-500/80 hover:bg-orange-500 rounded-t-sm transition-all" style={{ height: '84px' }}></div>
              <span className="text-[9px] font-bold text-gray-400">F</span>
            </div>
            {/* Saturday bar */}
            <div className="flex flex-col items-center gap-2 w-10">
              <span className="text-[9px] font-bold text-orange-605">₹15K</span>
              <div className="w-5 bg-[#FF7A00] hover:bg-[#ff9133] rounded-t-sm transition-all shadow-sm" style={{ height: '105px' }}></div>
              <span className="text-[9px] font-bold text-gray-500 font-extrabold">S</span>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`px-2 py-1 rounded text-[9px] font-bold uppercase transition-colors ${
                      rider.active
                        ? 'bg-red-50 text-red-500 border border-red-500/20 hover:bg-red-100/50'
                        : 'bg-green-50 text-green-500 border border-green-500/20 hover:bg-green-100/50'
                    }`}
                  >
